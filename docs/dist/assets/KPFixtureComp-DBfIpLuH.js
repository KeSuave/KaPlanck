import{u as d,j as e}from"./index-DZnhVgSO.js";const t={title:"Interface: KPFixtureComp",description:"undefined"};function i(r){const n={a:"a",blockquote:"blockquote",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...d(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"interface-kpfixturecomp",children:["Interface: KPFixtureComp",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#interface-kpfixturecomp",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.h3,{id:"fixture",children:["fixture",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#fixture",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"fixture"}),": ",e.jsx(n.code,{children:"null"})," | ",e.jsx(n.code,{children:"Fixture"})]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["• ",e.jsx(n.strong,{children:"btn?"}),": ",e.jsx(n.code,{children:"MouseButton"})]}),`
...
`,e.jsx(n.p,{children:e.jsx(n.code,{children:"KEventController"})})]})}function a(r={}){const{wrapper:n}={...d(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{a as default,t as frontmatter};
