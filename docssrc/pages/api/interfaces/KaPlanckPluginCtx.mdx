...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `opt` | [`KPBoxShapeCompOpts`](/api/interfaces/KPBoxShapeCompOpts) | The options for the box shape. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `opt`? | [`KPChainShapeCompOpt`](/api/interfaces/KPChainShapeCompOpt) | The options for the chain shape. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `opt`? | [`KPCircleShapeCompOpt`](/api/interfaces/KPCircleShapeCompOpt) | The options for the circle shape. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `opt`? | [`KPEdgeShapeCompOpt`](/api/interfaces/KPEdgeShapeCompOpt) | The options for the edge shape. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `opt`? | [`KPPolygonShapeCompOpt`](/api/interfaces/KPPolygonShapeCompOpt) | The options for the polygon shape. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `defs` | `KPShapeDef`[] | The definitions of the shapes. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `def`? | `null` \| `WorldDef` \| `Vec2` | The definition of the physics world or a vector for gravity. |
